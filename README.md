...
# Установка
Создать какую-либо директорию на любом диске, где свободно ~400мб, перенести туда файл installVideoDownloader.cmd и запустить его там. В процессе установки будут загружены:
